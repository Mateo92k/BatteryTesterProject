...
public class PriceExpensiveAndTImeVeryGoodRule implements IRule {
    @Override
    public void Run(FuzzyConclusionSet conclusionSet) {
        conclusionSet.set_veryGoodRatingValue(Math.min(conclusionSet.PriceExpensive,conclusionSet.TimeVeryGood));
    }
}
